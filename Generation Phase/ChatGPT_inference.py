...
def return_key(role: str, correctness: bool) -> str:
  if role == 'chatgpt':
    ...
    return ('human_true', 'answer') if correctness else ('human_false_llama', 'llama_false_ans')
...
def LLM_vs_LLM_exp(EXPECTED_LENGTH: int, RESULT_DIR: str, num: str, passage_1_correctness: bool, passage_2_correctness: bool):
  condition_1 = return_key('chatgpt', passage_1_correctness)
  condition_2 = return_key('llama', passage_2_correctness)
